...
export async function POST(request: NextRequest) {
  try {
    ...
    const productData: any = {
      ...
      shippingCountries: shippingCountries && Array.isArray(shippingCountries) ? shippingCountries : [],
      shippingMethods: shippingMethods && Array.isArray(shippingMethods) && shippingMethods.length > 0 ? shippingMethods : null,
